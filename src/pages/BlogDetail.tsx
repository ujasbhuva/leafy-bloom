      ...
      <div className="flex flex-col min-h-screen">
        ...
        <div className="container mx-auto px-4 py-12 flex-grow">
          <div className="text-center">
            <h1 className="text-2xl font-display font-medium mb-4">Blog post not found</h1>
            ...
            <div className="flex flex-wrap items-center gap-4 text-muted-foreground mb-8 pb-4 border-b border-plant-beige">
              ...
              <div className="flex flex-wrap items-center gap-2 mt-2 md:mt-0">
                ...
                {blog.tags.map((tag, index) => (
                  <Badge key={index} variant="outline" className="bg-plant-beige/30 border-plant-beige">
                    {tag}
                  </Badge>
                ))}
              </div>
